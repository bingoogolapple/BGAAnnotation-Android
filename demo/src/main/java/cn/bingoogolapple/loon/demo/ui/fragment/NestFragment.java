 ...
 */
@LoonLayout(id = R.layout.fragment_nest)
public class NestFragment extends BaseFragment {
    ...
    @LoonView(id = R.id.rg_nest_tab)
    private RadioGroup mTabRg;
    @LoonView(id = R.id.vp_nest_pager)
    ...
    @LoonLayout(id = R.layout.fragment_nest_one)
    ...
    @LoonLayout(id = R.layout.fragment_nest_two)
    ...
    @LoonLayout(id = R.layout.fragment_nest_three)
